...
#include <memory>
#include "../../SNet-master/UI/LinkDialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LinkDialog_t, stringdata0) + ofs), len 
...
const QMetaObject LinkDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_LinkDialog.offsetsAndSize,
    qt_meta_data_LinkDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LinkDialog_t
